...
!define URL http://www.ghostcoin.io/

# MUI Symbol Definitions
!define MUI_ICON "../share/pixmaps/ghostcoin.ico"
...
Section -Main SEC0000
    ...
    File ../src/ghostcoind.exe
    SetOutPath $INSTDIR\src
    File /r /x *.exe /x *.o ../src\*.*
    SetOutPath $INSTDIR
    WriteRegStr HKCU "${REGKEY}\Components" Main 1

    # Remove old wxwidgets-based-ghostcoin executable and locales:
    Delete /REBOOTOK $INSTDIR\ghostcoin.exe
...
Section -post SEC0001
    ...
    WriteRegStr HKCR "ghostcoin" "" "URL:Ghostcoin"
