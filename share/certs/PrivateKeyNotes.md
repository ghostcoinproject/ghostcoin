...
unlocked to sign the Ghostcoin-Qt.app bundle.
...
allowing somebody to distribute a Ghostcoin-Qt.app or ghostcoin-qt-setup.exe with a valid
...
that the ghostcoin-qt.exe file inside the installer had not been tampered with.
