...
---------------------
	...
	cd src/
	make -f makefile.unix		# Headless Ghostcoin

See readme-qt.rst for instructions on building Ghostcoin-Qt, the graphical user interface.
...
Notes
-----
The release is built with GCC and then "strip ghostcoind" to strip the debug
...
Security
--------
To help make your Ghostcoin installation more secure by making certain attacks impossible to
...
* Non-executable Stack
    ...
    vulnerable buffers are found. By default, Ghostcoin should be built with a non-executable stack
