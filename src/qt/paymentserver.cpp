...
const QString BITCOIN_IPC_PREFIX("ghostcoin:");
...
{
    // Install global event filter to catch QFileOpenEvents on the mac (sent when you click ghostcoin: links)
    ...
    if (!uriServer->listen(name))
        qDebug() << tr("Cannot start ghostcoin: click-to-pay handler");
    else
...
{
    // clicking on ghostcoin: URLs creates FileOpen events on the Mac:
