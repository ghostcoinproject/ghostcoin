...
enum DiffMode {
    DIFF_CLASSIC_GHOST	= 1, // Retarget every 720 blocks (Classic Ghostcoin style)
    DIFF_GHOST		= 2, // Retarget every 60 blocks (Ghostcoin style)
...
static const int64 DUST_SOFT_LIMIT = 75000; // 0.00075 GHOST
/** Dust Hard Limit, ignored as wallet inputs (mininput default) */
static const int64 DUST_HARD_LIMIT = 2500;   // 0.000025 GHOST mininput
...
public:
    ...
    */
    ...
    /** Amount of ghostcoins spent by this transaction.
    ...
    /** Amount of ghostcoins coming in to this transaction
