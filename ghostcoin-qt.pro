...
RESOURCES += src/qt/ghostcoin.qrc
...
# also add new translations to src/qt/ghostcoin.qrc under translations/
...
win32:DEFINES += WIN32
win32:RC_FILE = src/qt/res/ghostcoin-qt.rc
...
macx:ICON = src/qt/res/icons/ghostcoin.icns
